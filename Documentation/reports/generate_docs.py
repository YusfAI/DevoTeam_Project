...
def build_rapport_professionnel():
    ...
    add_table(doc,
        ...
        [
            ...
            ["Tests", "pytest (622 tests)", "Suite automatisée sans dépendance réseau ni données réelles "
    ...
    add_bullet(doc, "622 tests automatisés couvrent la compréhension du langage, le requêtage des "
...
def build_guide_technique():
    ...
    add_table(doc,
        ...
        [
            ...
            ["tests/", "Suite pytest — 622 tests, aucune dépendance réseau ni données réelles."],
    ...
    add_body(doc,
        "622 tests pytest, sans dépendance réseau ni données réelles : le client du "
...
def build_presentation_script():
    ...
    add_body(doc,
        ...
        "seule requête SQL soit construite. Et cette architecture est vérifiée par plus de "
        "six cents tests automatisés, qui tournent sans base de données réelle ni connexion internet.")
    ...
    add_bullet(doc, "622 tests automatisés, aucune dépendance à des données réelles.")
    add_bullet(doc, "46 phases de développement livrées, de bout en bout, en autonomie.")
